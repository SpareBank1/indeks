import { CssImportBlock } from '@site/docs/kom-i-gang/InstallSnippets';
...
:::info `--ii-` vs `--ix-`
`--ii-primitive-*` er interne primitiver. Ikke bruk dem direkte i applikasjonskoden din. `--ix-color-*` er det offentlige API-et du styler mot.
:::
