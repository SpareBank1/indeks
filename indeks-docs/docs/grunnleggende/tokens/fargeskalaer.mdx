...
:::tip Å justere mørkhetsgraden på en basisfarge har ingen effekt
...
Bakgrunnen for valget av OKLCH — hvorfor HSL ble forkastet, hvorfor de publiserte tokenene er frosne hex-verdier (ikke `oklch()` i runtime), og hvordan dark mode bruker andre trinn i samme skala — er dokumentert i [ADR-DS-007: Fargesystem](../../adr/ADR-DS-007-fargesystem).
