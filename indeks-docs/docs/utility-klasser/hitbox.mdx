...
kontrollere utvidelsen i de retningene du trenger. Utvidelsene følger spacing-skalaen. Trenger du
en verdi som ikke finnes der, velg den nærmeste.
...
Passer til lenker og knapper i navigasjon: treffarealet vokser sidelengs uten at linjehøyden endrer seg.
...
Til ikoner og kompakte verktøylinjeknapper, der det er plass over og under, men ikke ved siden av.
...
Til elementer som sitter langs en kant og bare kan vokse innover, for eksempel en lukk-knapp i et hjørne.
...
Pseudo-elementet legger seg over det som ligger inntil, med mindre elementet står i en beholder med
`overflow: hidden` eller `clip-path`. To hitboxer som overlapper gir et areal der brukeren treffer
noe annet enn det hen sikter på, så hold nok avstand mellom klikkbare elementer.
