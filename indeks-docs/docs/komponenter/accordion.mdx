...
Headeren er det eneste brukeren har å gå etter før hen åpner seksjonen. Sett det viktigste
ordet først, og hold den kort nok til å skannes nedover lista. Må seksjonen åpnes for at
headeren skal gi mening, er headeren for vag.

### Ikke legg accordion i accordion

To nivåer med åpne og lukkede seksjoner er vanskelig å holde oversikt over. Trenger du
flere nivåer, del innholdet på egne sider eller i [faner](./tabs) i stedet.
