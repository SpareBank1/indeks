...
- Du kan også bruke [spacing-variabler](../grunnleggende/tokens/utilities#spacing) eller util-klasser til å sette margin selv.
...
- [Spacing-tokens og utility-klasser](../grunnleggende/tokens/utilities#spacing)
