...
```jsx live
<>
  <p className="ix-text ix-text--md">Saldo: <strong>12 345,00 kr</strong></p>
  <p className="ix-text ix-text--md">Renten er <em>variabel</em> og kan endres.</p>
</>
```
...
<p class="ix-text ix-text--md ix-text--long">
  Renten på boliglånet ditt er basert på Nibor pluss et påslag.
</p>
