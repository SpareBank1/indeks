...
<div className="ix-message" data-status="success" aria-live="polite">
  ...
  <button className="ix-interactive-icon ix-message__close" data-size="sm" type="button" aria-label="Lukk melding">
...
<div class="ix-message" data-status="info" aria-live="polite">
  ...
  <button class="ix-interactive-icon ix-message__close" data-size="sm" type="button" aria-label="Lukk melding">
