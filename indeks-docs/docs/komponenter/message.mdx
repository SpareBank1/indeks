...
<div className="ix-message" data-status="success" aria-live="polite">
  ...
  <button className="ix-interactive-icon ix-message__close" type="button" aria-label="Lukk melding">
    <ix-icon name="lukk" aria-hidden="true" className="ix-icon"></ix-icon>
  </button>
</div>
```
...
| Lukkeknapp | `.ix-interactive-icon` (+ `.ix-message__close` for plassering) med `<ix-icon name="lukk">` |
...
<div class="ix-message" data-status="info" aria-live="polite">
  ...
  <button class="ix-interactive-icon ix-message__close" type="button" aria-label="Lukk melding">
    <ix-icon name="lukk" aria-hidden="true" class="ix-icon"></ix-icon>
  </button>
</div>
