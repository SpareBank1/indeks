...
Panelet åpner på hover etter 300 ms, og med en gang på fokus og tapp. Det lukker når pekeren forlater triggeren, når fokus flyttes videre, og på `Escape`. Ikke bygg en egen lukkeknapp, og ikke legg noe brukeren skal rekke bort til inni panelet. Bare én tooltip er synlig om gangen, så to hjelpetekster som hører sammen må skrives som én.
