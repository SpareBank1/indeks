...
I tillegg støttes øvrige HTML-attributter (`aria-*`, `data-*`, `tabIndex`, osv.) som settes direkte på komponenten. De sendes videre til `<ix-phone-number-field>`-**host-elementet**, ikke de indre delfeltene.
