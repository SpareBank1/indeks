...
<label class="ix-checkbox">
  <input type="checkbox" class="ix-checkbox__input" name="terms" />
  <span class="ix-checkbox__box" />
  <span class="ix-checkbox__label">Jeg godtar vilkårene</span>
</label>
```
...
<ix-field>
  <label class="ix-checkbox">
    <input type="checkbox" class="ix-checkbox__input" name="newsletter" />
    <span class="ix-checkbox__box" />
    <span class="ix-checkbox__label">Send meg nyhetsbrev</span>
  </label>
...
<ix-field>
  <label class="ix-checkbox">
    <input type="checkbox" class="ix-checkbox__input" name="terms" aria-invalid="true" />
    <span class="ix-checkbox__box" />
    <span class="ix-checkbox__label">Jeg godtar vilkårene</span>
  </label>
...
function IndeterminateCheckbox() {
  ...
  return (
    <label class="ix-checkbox">
      <input ref={ref} type="checkbox" class="ix-checkbox__input" name="select-all" />
      <span class="ix-checkbox__box" />
      <span class="ix-checkbox__label">Velg alle</span>
    </label>
  );
}
```
...
```jsx live
<>
  <label class="ix-checkbox ix-checkbox--disabled">
    <input type="checkbox" class="ix-checkbox__input" disabled />
    <span class="ix-checkbox__box" />
    <span class="ix-checkbox__label">Ikke tilgjengelig</span>
  </label>
  <label class="ix-checkbox ix-checkbox--disabled">
    <input type="checkbox" class="ix-checkbox__input" disabled defaultChecked />
    <span class="ix-checkbox__box" />
    <span class="ix-checkbox__label">Allerede godtatt</span>
  </label>
</>
```
...
<fieldset style={{ border: 'none', padding: 0, margin: 0 }}>
  ...
  <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
    <label class="ix-checkbox">
      <input type="checkbox" class="ix-checkbox__input" name="contact" value="email" />
      <span class="ix-checkbox__box" />
      <span class="ix-checkbox__label">E-post</span>
    </label>
    <label class="ix-checkbox">
      <input type="checkbox" class="ix-checkbox__input" name="contact" value="sms" />
      <span class="ix-checkbox__box" />
      <span class="ix-checkbox__label">SMS</span>
    </label>
    <label class="ix-checkbox">
      <input type="checkbox" class="ix-checkbox__input" name="contact" value="phone" />
      <span class="ix-checkbox__box" />
      <span class="ix-checkbox__label">Telefon</span>
    </label>
  </div>
</fieldset>
```
