...
- Lengre fritekst. Bruk [TextArea](./textarea) i stedet.
...
<>
  <ix-field>
    <label>Beløp i kroner</label>
    <span data-field="description">Beløp med tusenskille, f.eks. 1 234 567</span>
    <div class="ix-text-field">
      <input type="text" inputmode="decimal" data-format="amount" value="1234567" />
      <div data-field="suffix">kr</div>
    </div>
    <span data-field="error"></span>
  </ix-field>
  <ix-field>
    ...
    <div class="ix-text-field">
      <input type="text" inputmode="numeric" data-format="account" value="12345678903" />
    </div>
    <span data-field="error"></span>
  </ix-field>
</>
...
<>
  <TextField
    label="Beløp i kroner"
    description="Beløp med tusenskille, f.eks. 1 234 567"
    format="amount"
    suffix="kr"
    inputMode="decimal"
  ...
  <TextField
    label="Kontonummer"
    description="11 siffer, f.eks. 1234 56 78903"
    format="account"
    inputMode="numeric"
...
Verdien du leser av `onChange` er alltid den rå verdien uten separatorer (den ligger i en skjult mirror-input som også brukes ved form-innsending). Se [Formatering](./textfield-formatering) for de to modusene, de tre måtene å definere en formatter på, egne varianter, og tilgjengelighetshensyn.
...
<>
  <ix-field>
    <label>Kontonummer</label>
    <div class="ix-text-field">
      <input value="1234 56 78903" disabled />
    </div>
    <span data-field="error"></span>
  </ix-field>
  <ix-field>
    <label>Kontonummer</label>
    <div class="ix-text-field">
      <input value="1234 56 78903" readonly />
    </div>
    <span data-field="error"></span>
  </ix-field>
</>
...
Hjelpeteksten sier hva formatet er eller hva feltet skal inneholde. Ett kort avsnitt er
nok, og det du sparer der slipper brukeren å lese.
...
"Ugyldig verdi" forteller brukeren at noe er galt, ikke hva som skal til for å komme
videre. Skriv hva kravet er.
...
Ikke valider mens brukeren skriver. Et felt som slår ut i rødt etter tredje tegn i en
e-postadresse har rett, men på feil tidspunkt.

### Tilpass bredden til verdien

La bredden si noe om hvor lang verdien er: et smalt felt til postnummer, et bredt til
adresse. Da kan brukeren skanne skjemaet uten å lese hver label, og et felt som ikke
passer verdien blir et hint om at noe er feil.

### Gjenta prefix og suffix i labelen

Prefix og suffix er visuell kontekst, og skjermlesere leser dem ikke nødvendigvis opp. Et
felt med "kr" foran skal ha labelen "Beløp i kroner", ikke bare "Beløp".
...
<>
  ...
  <ix-field>
    ...
    <div class="ix-text-field">
      <input value="ORD-2026-0042" readonly />
    </div>
    <span data-field="error"></span>
  </ix-field>
</>
...
- [Label](./label) — reglene for labeltekst, felles for alle skjemafelt
