...
```jsx live
<>
  <button type="button" data-size="xs" class="ix-interactive-icon" aria-label="Liten">
    <ix-icon name="edit" aria-hidden="true" class="ix-icon"></ix-icon>
  </button>
  <button type="button" data-size="sm" class="ix-interactive-icon" aria-label="Medium">
    <ix-icon name="edit" aria-hidden="true" class="ix-icon"></ix-icon>
  </button>
  <button type="button" data-size="md" class="ix-interactive-icon" aria-label="Stor">
    <ix-icon name="edit" aria-hidden="true" class="ix-icon"></ix-icon>
  </button>
  <button type="button" data-size="lg" class="ix-interactive-icon" aria-label="Ekstra stor">
    <ix-icon name="edit" aria-hidden="true" class="ix-icon"></ix-icon>
  </button>
</>
```
