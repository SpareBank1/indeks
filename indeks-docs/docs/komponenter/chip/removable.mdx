...
```jsx live
<ix-stack horizontal gap="sm">
  <button class="ix-chip" data-removable data-state="error" aria-label="Sparing fjern">Sparing</button>
  <button class="ix-chip" data-removable data-state="readonly" aria-disabled="true" aria-label="Lån fjern">Lån</button>
</ix-stack>
```
...
```tsx live
<HStack gap="sm">
  <RemovableChip error removeLabel="fjern" onRemove={() => {}}>Sparing</RemovableChip>
  <RemovableChip readOnly removeLabel="fjern" onRemove={() => {}}>Lån</RemovableChip>
</HStack>
```
