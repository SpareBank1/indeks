...
```jsx live
<ix-radio-group data-variant="chip" data-size="sm" name="periode-liten">
  <span data-field="legend">Velg periode</span>
  <div data-field="items">
    <div class="ix-radio-button">
...
```tsx live
<RadioChipGroup legend="Velg periode" name="periode-liten" size="sm" defaultValue="3m">
  <RadioChip value="1m" label="1 måned" />
  <RadioChip value="3m" label="3 måneder" />
  <RadioChip value="12m" label="12 måneder" />
</RadioChipGroup>
...
```jsx live
<ix-radio-group data-variant="chip" name="nyhetsbrev">
