...
- **Valgt tilstand** kommuniseres med fylt firkant-indikator (hake), aksent-kant og fyll, ikke farge alene. Tilstanden eksponeres programmatisk via native `aria-checked`.
