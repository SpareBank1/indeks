...
<a class="ix-button" data-variant="secondary" href="/tilbake">
  <span class="ix-icon" style={{maskImage: "url(https://cdn.sparebank1.no/icons/arrow_back.svg)", WebkitMaskImage: "url(https://cdn.sparebank1.no/icons/arrow_back.svg)"}} aria-hidden="true" />
...
```tsx live
<Button as="a" variant="secondary" href="/tilbake">
