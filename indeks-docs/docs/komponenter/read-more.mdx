...
- Flere seksjoner som hører sammen — bruk heller [Accordion](./accordion)
...
Labelen er alt brukeren har å gå etter, så den må gi mening lest alene, med det viktigste ordet
først. «Slik regner vi ut renten» forteller hva som ligger bak. «Les mer» gjør det ikke.

### Bruk ReadMore alene, Accordion for flere

ReadMore er én forklaring i en tekstflate. Har du flere seksjoner som hører sammen og bør stå
samlet, hører de i en [Accordion](./accordion).
...
[Accordion](./accordion#designvalg).
