...
Bruk ReadMore for **én** enkeltstående forklaring i tekstflaten. Har du **flere** seksjoner som hører sammen og bør stå i et samlet kort, bruk [Accordion](./accordion) i stedet.
