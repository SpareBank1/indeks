...
Labelen tar innhold, så du kan sette et ikon foran teksten. Teksten er alltid hovedbæreren — ikonet er kun støtte.
...
<details class="ix-read-more">
  <summary>
    <ix-icon name="info"></ix-icon> Om helsemessige begrensninger
  </summary>
  <div class="ix-read-more__content">
    <p>Med helsemessige begrensninger mener vi funksjonshemming, sykdom eller skade som påvirker hverdagen din over tid.</p>
  </div>
...
```tsx live
<ReadMore label={<><Icon name="info" /> Om helsemessige begrensninger</>}>
  <p>Med helsemessige begrensninger mener vi funksjonshemming, sykdom eller skade som påvirker hverdagen din over tid.</p>
</ReadMore>
```
...
- **Skriv kort og beskrivende label-tekst** — labelen er klikkflaten og må gi mening alene. Et valgfritt prefiks-ikon støtter, men teksten er alltid hovedbæreren.
...
|------|------|----------|-------------|
| `label` | `ReactNode` | | Klikkbar label (kort og beskrivende, kan inkludere et prefiks-ikon) |
