...
Rett under tabellen eller listen, uten annet innhold imellom. Er tabellen så lang at
pagineringen forsvinner ut av skjermen, gjenta den over også, så brukeren finner den både før
og etter lesingen.
