...
| `inputProps` | `InputHTMLAttributes` | Nei | | Alle standard HTML input-attributter. Settes direkte på `<input>`. Bruk `inputProps={{ name: 'feltnavn' }}` for nativ skjema-innsending |
