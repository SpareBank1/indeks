...
```jsx live
<>
  <div className="ix-spinner" role="status" aria-label="Liten spinner" data-size="sm" />
  <div className="ix-spinner" role="status" aria-label="Middels spinner" data-size="md" />
  <div className="ix-spinner" role="status" aria-label="Stor spinner" data-size="lg" />
</>
```
