import { HStack, VStack } from '@sb1/indeks-react';
import React from 'react';
import { Link } from 'react-router-dom';

interface Props {
    activeArea: 'eksempelsider' | 'internTesting';
    setActiveArea?: React.Dispatch<React.SetStateAction<'eksempelsider' | 'internTesting'>>;
}

const Header: React.FC<Props> = ({ activeArea, setActiveArea }) => {
                    ...
                    <svg viewBox="0 0 182 40" xmlns="http://www.w3.org/2000/svg" style={{ height: '30px' }}>
                        ...
                        <g fill="none" fillRule="evenodd">
                            ...
                            <path
                                ...
                                fill="var(--ix-color-foreground-main-default)"
                            />
                        </g>
                    </svg>
                </a>

                <HStack gap="sm" className="ix-font-size-lg">
                    <Link
                        to={'/eksempelsider/oversikt'}
                        onClick={() => setActiveArea && setActiveArea('eksempelsider')}
                        style={linkStyles('eksempelsider')}
                    >
                        EKSEMPELSIDER
                    </Link>
                    <Link
                        to={'/internTesting/oversikt'}
                        onClick={() => setActiveArea && setActiveArea('internTesting')}
                        style={linkStyles('internTesting')}
                    >
                        INTERN TESTING
                    </Link>
                </HStack>
